  ...
  render() {
    ...
    const menu = (
      <Menu selectable={false}>
        <Menu.Item>
          <strong>
            {formatMessage({ id: "topBar.profileMenu.hello" })},{" "}
            {user.name || "Anonymous"}
          </strong>
          <div>
          ...
          <div>
            <strong className="mr-1">
              {formatMessage({ id: "topBar.profileMenu.role" })}:
            </strong>
            {user.role}
          </div>
        </Menu.Item>
        ...
        <Menu.Item>
          <div>
            <strong className="mr-1">
              {formatMessage({ id: "topBar.profileMenu.email" })}:
            </strong>
            {user.email}
            <br />
            <strong className="mr-1">
              {formatMessage({ id: "topBar.profileMenu.phone" })}:
            </strong>
            {user.phone || "-"}
          </div>
        </Menu.Item>
