  ...
  render() {
    const menu = (
      <Menu selectable={false} className={styles.activity}>
        <Menu.Item className={styles.item}>
          ...
          <div className={styles.inner}>
            ...
            <div className={styles.descr}>
              Failed to get available update data. To ensure the proper
              functioning of your application, update now.
            </div>
          </div>
        </Menu.Item>
        <Menu.Item className={styles.item}>
        ...
        <Menu.Item className={styles.item}>
          <i
            className={`${styles.icon} icmn-cog utils__spin-delayed--pseudo-selector`}
          />
          <div className={styles.inner}>
            <div className={styles.title}>
              <span className="pull-right">30 min ago</span>
